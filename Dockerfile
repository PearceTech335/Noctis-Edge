# =============================================================================
#  Noctis Edge v0.11.4 — Dockerfile
...
#    Built at image-build time from NVD JSON 2.0 feeds.  Falls back
#    gracefully if the network is unavailable; the entrypoint will retry
