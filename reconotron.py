#!/usr/bin/env python3
"""
NoctisCore — AI-Assisted Penetration Testing Platform
...
<head>
<meta charset="UTF-8">
<title>NoctisCore Report — {{ target }}</title>
<style>
...
<body>
<h1>NoctisCore Penetration Test Report</h1>
<p style="color:#aaa;font-style:italic;margin-top:-6px">Security through exposure</p>
...
<footer>Generated by NoctisCore &bull; {{ generated_at }}</footer>
</body>
</html>"""
...
async def main_async():
    ...
    print(f"\n{'=' * 60}")
    print("  NoctisCore — AI-Assisted Penetration Testing Platform")
    print("  Security through exposure")
    print(f"{'=' * 60}")
    print(f"  Target  : {target}")
