#!/usr/bin/env python3
"""
ReconoTron — AI-Assisted Penetration Testing Platform
...
<head>
<meta charset="UTF-8">
<title>ReconoTron Report — {{ target }}</title>
<style>
...
<footer>Generated by ReconoTron &bull; {{ generated_at }}</footer>
</body>
</html>"""
...
async def main_async():
    ...
    print(f"\n{'=' * 60}")
    print("  ReconoTron — AI-Assisted Penetration Testing Platform")
    print(f"{'=' * 60}")
    print(f"  Target  : {target}")
